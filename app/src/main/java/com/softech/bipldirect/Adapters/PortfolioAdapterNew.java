...
//
//    public PortfolioAdapterNew(Context context, List<Portfolio> arrayList,OnPortofolioClickListner portofolioClickListner) {
//        mContext = context;
...
//        colorBlack = ContextCompat.getColor(context, R.color.blackBackground);
//
//    }
//
//    @Override
...
//                        .inflate(R.layout.portfolio_list_itemm, viewGroup, false);
...
//
//
//                String profitloss=obj.getCapGainLoss();
//                int index1 = profitloss.indexOf(".");
//                if (index1 > 0)
//                    profitloss = profitloss.substring(0, index1);
//                viewHolder1.totalPortfolio.setText(profitloss);
//
//
//
...
//                String totalCost=obj.getTotalCost();
//                int index = totalCost.indexOf(".");
//                if (index > 0)
//                    totalCost = totalCost.substring(0, index);
//                viewHolder1.totalPortfolio.setText(totalCost);
